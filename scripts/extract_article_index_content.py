#!/usr/bin/env python3
"""Extract the public article collection index into a Markdown source."""
...
PAGE = shared.Page(
    ...
    output_path="content/article/index.md",
...
def extract() -> str:
    """Use the established visible-main renderer with the article identifier."""
    original_series = shared.SERIES
    try:
        shared.SERIES = "article"
...
def main() -> int:
    ...
    try:
        ...
        print(f"article index extraction: FAILED\n{exc}", file=sys.stderr)
        return 1
    mode = "check" if args.check else "write"
    print(f"article index extraction: OK ({mode}, 1 Markdown source)")
    return 0
